...
<header id="top-nav">
	...
	<p class="navbarlinks"><a href="../">Outils</a>   &gt;   <a href=".">Code couleur des résistors</a></p>
</header>

<svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 520 230" width="520" height="230" version="1.1" id="svg-resistor">
...
function color2value(what, color) {
	switch (color) {
		...
		case '#ccc': return (what == 'M') ? '0.01' : '± 10 %'; break;
		case '#fc0': return (what == 'M') ? '0.1' : '± 5 %'; break;
